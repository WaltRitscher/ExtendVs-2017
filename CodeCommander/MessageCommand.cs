//------------------------------------------------------------------------------
// <copyright file="MessageCommand.cs" company="Company">
...
namespace CodeCommander {
	...
	internal sealed class MessageCommand {
		...
		private MessageCommand(Package package) {
			if (package == null)
			{
		...
		/// </summary>
		public static MessageCommand Instance {
			get;
			private set;
		}
		...
		public static void Initialize(Package package) {
			Instance = new MessageCommand(package);
		}
