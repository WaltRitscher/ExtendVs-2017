...
namespace CodeEcho
{
  ...
  /// <summary>
  /// Adornment class that places the WPF page in upper right hand corner of
  /// the viewport
  /// </summary>
  internal class CodeEchoAdornment
  {
    ...
    /// <param name="view">
    /// The <see cref="IWpfTextView"/> upon which the adornment will be drawn
    /// </param>
    ...
    private void View_TextEditorLayoutChanged(object sender, TextViewLayoutChangedEventArgs e)
    {
      ...
      _adornmentLayer.AddAdornment(behavior: AdornmentPositioningBehavior.ViewportRelative,
                                   visualSpan: null,
                                   tag: null,
                                   adornment: _statsPage,
    ...
    {
      // leave this method in the code getting an exception without it. fix
    }
    ...
    {
      string langtype = view.FormattedLineSource
                        .TextAndAdornmentSequencer.SourceBuffer
